...
def beforeTriggerExec():
    DoActions([
        ...
        SetMemory(0x660A70 + 244, SetTo, 18350355),
        SetMemory(0x660A70 + 248, SetTo, 19005725),
        SetMemory(0x660A70 + 252, SetTo, 0),
        SetMemory(0x660A70 + 256, SetTo, 0),
        SetMemory(0x660A70 + 260, SetTo, 19333120),
        SetMemory(0x660A70 + 264, SetTo, 19923243),
        SetMemory(0x660A70 + 268, SetTo, 20578613),
        SetMemory(0x660A70 + 272, SetTo, 21233983),
        SetMemory(0x660A70 + 276, SetTo, 22085961),
        SetMemory(0x660A70 + 280, SetTo, 23134556),
        SetMemory(0x660A70 + 284, SetTo, 24379753),
        SetMemory(0x660A70 + 288, SetTo, 376),
        SetMemory(0x660A70 + 292, SetTo, 380),
        SetMemory(0x660A70 + 296, SetTo, 25165824),
        SetMemory(0x660A70 + 300, SetTo, 0),
        SetMemory(0x660A70 + 304, SetTo, 0),
        SetMemory(0x660A70 + 308, SetTo, 25559427),
        SetMemory(0x660A70 + 312, SetTo, 26018186),
        SetMemory(0x660A70 + 316, SetTo, 26214400),
        SetMemory(0x660A70 + 320, SetTo, 404),
        SetMemory(0x660A70 + 324, SetTo, 27001240),
        SetMemory(0x660A70 + 328, SetTo, 27525536),
        SetMemory(0x660A70 + 332, SetTo, 28049832),
        SetMemory(0x660A70 + 336, SetTo, 28311552),
        SetMemory(0x660A70 + 340, SetTo, 28901812),
        SetMemory(0x660A70 + 344, SetTo, 445),
