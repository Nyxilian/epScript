...
def onPluginStart():
    ...
    # 버튼셋
    bytebuffer = bytearray([1,0,228,0,208,130,66,0,64,68,66,0,0,0,0,0,152,2,0,0,2,0,229,0,208,130,66,0,240,51,66,0,0,0,0,0,153,2,0,0,3,0,230,0,48,143,66,0,128,67,66,0,0,0,0,0,154,2,0,0,4,0,254,0,208,130,66,0,64,65,66,0,0,0,0,0,155,2,0,0,5,0,255,0,208,130,66,0,112,51,66,0,0,0,0,0,156,2,0,0,6,0,93,1,96,142,66,0,176,52,66,0,9,0,9,0,29,4,0,0,7,0,252,0,224,147,66,0,48,55,66,0,10,0,10,0,88,1,99,1,7,0,253,0,112,147,66,0,112,50,66,0,10,0,0,0,89,1,0,0,8,0,240,0,224,148,66,0,112,63,66,0,1,0,1,0,79,1,91,1])
    btnptr16 = Db(bytebuffer)
    DoActions([
        SetMemory(0x5188AC, SetTo, btnptr16),
        SetMemory(0x5188A8, SetTo, 9),
    ])
...
def beforeTriggerExec():
    DoActions([
        ...
        SetMemory(0x660A70 + 24, SetTo, 51),
        SetMemory(0x660A70 + 28, SetTo, 59),
        ...
        SetMemory(0x660A70 + 92, SetTo, 7471214),
        SetMemory(0x660A70 + 96, SetTo, 0),
        SetMemory(0x660A70 + 100, SetTo, 121),
        SetMemory(0x660A70 + 104, SetTo, 0),
        SetMemory(0x660A70 + 108, SetTo, 0),
        SetMemory(0x660A70 + 112, SetTo, 0),
        SetMemory(0x660A70 + 116, SetTo, 125),
        SetMemory(0x660A70 + 120, SetTo, 9044102),
        SetMemory(0x660A70 + 124, SetTo, 143),
        SetMemory(0x660A70 + 128, SetTo, 9961620),
        SetMemory(0x660A70 + 132, SetTo, 10420379),
        SetMemory(0x660A70 + 136, SetTo, 10682368),
        SetMemory(0x660A70 + 140, SetTo, 11075750),
        SetMemory(0x660A70 + 144, SetTo, 11600045),
        SetMemory(0x660A70 + 148, SetTo, 0),
        SetMemory(0x660A70 + 152, SetTo, 0),
        SetMemory(0x660A70 + 156, SetTo, 0),
        SetMemory(0x660A70 + 160, SetTo, 0),
        SetMemory(0x660A70 + 164, SetTo, 12058624),
        SetMemory(0x660A70 + 168, SetTo, 12583100),
